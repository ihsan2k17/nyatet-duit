  ...
  return (
    <Label
      ...
      className={cn(
        ...
        // disabled
        "group-data-[disabled=true]/field:text-(--color-disabled)",
        ...
        "has-[>[data-slot=field]]:border-(--color-border)",

        // padding for inner field
        "*:data-[slot=field]:p-4",

        // checked state
        "has-data-[state=checked]:border-(--color-ring)",
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-text-primary text-sm leading-normal font-medium", 
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="bg-transparent text-text-primary font-semibold relative mx-auto block w-fit px-2"
